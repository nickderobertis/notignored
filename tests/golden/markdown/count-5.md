...
- **rust dead\_code** — _the shellcheck parser lands in the next change_ — [tests/fixtures/markdown/guard.rs:1](https://github.com/acme/widgets/blob/0123456789abcdef0123456789abcdef01234567/tests/fixtures/markdown/guard.rs#L1)

  <details>
  <summary>suppressed code</summary>

  ```rust
  1 | #[allow(dead_code, reason = "the shellcheck parser lands in the next change")]
  2 | fn planned() -> u32 {
  3 |     0
  4 | }
  ```
