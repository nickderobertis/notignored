...
export NOTIGNORED_PRESERVED_LOGS="${NOTIGNORED_PRESERVED_LOGS-}"
...
preserved_log_open() {
  ...
  NOTIGNORED_PRESERVED_LOGS="${NOTIGNORED_PRESERVED_LOGS:+${NOTIGNORED_PRESERVED_LOGS}
}$path"
  export NOTIGNORED_PRESERVED_LOGS
...
_preserved_log_claimed() {
  ...
  done <<<"$NOTIGNORED_PRESERVED_LOGS"
  return 1
}
